...
/**
 * "Quack?" — the three things the product does.
 *
  ...
  return (
    <section ref={ref} className={styles.section} id="quack" aria-labelledby="quack-heading">
      ...
      <div className={styles.body}>
        <Reveal className={styles.tabsWrap} from="left" delay={0.1}>
        <div
        ...
        <Reveal className={styles.panelWrap} from="right" delay={0.2}>
        <div className={styles.panel}>
          ...
          {TABS.map((label, i) => (
            <div
              ...
              inert={i !== tab}
            >
              {i === 0 && <UniCarousel active={tab === 0 && onScreen} />}
